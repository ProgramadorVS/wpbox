...
$env = [
    [
        ...
        'fields' => [
            ...
            // Esta es la sección destacada
            ['title' => 'Paginación total', 'key' => 'PAGINATE_COUNT', 'value' => 20, 'help' => 'Paginación de las tablas '],
            ...
            ['separator' => '☁️ Storage settings', 'title' => 'File system for storage', 'help' => 'Where the system will store the media - images, videos, sounds.', 'key' => 'STORAGE_TYPE', 'value' => 'public_uploads', 'ftype' => 'select', 'data' => ['public_uploads' => 'Local filesystem']],
