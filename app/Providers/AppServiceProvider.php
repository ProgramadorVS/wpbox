...
use App\Auth\PlainTextOrHashedUserProvider;
...
class AppServiceProvider extends ServiceProvider
{
   ...
   // 1. REGISTRAS TU PROVEEDOR CUSTOM
            Auth::provider('plain_or_hash', function ($app, array $config) {
                return new PlainTextOrHashedUserProvider($app['hash'], $config['model']);
            });
