...
class Buttons extends Node
{
    public function listenForReply($message, $data){
       $extraData = $data->extra;
        ...
        Log::info('Valor de extraData en listenForReply', ['extraData' => $extraData]);
       ...
       if($extraData !== null && $extraData !== ''){
            ...
            Log::info('No extra data found', ['extraData' => $extraData]);
       }
    ...
    {
        Log::info('xxProcessing message in buttons node', ['message' => $message, 'data' => $data]);
