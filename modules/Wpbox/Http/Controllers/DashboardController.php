...
class DashboardController extends Controller
{
    ...
    {
        if(auth()->user()->hasRole(['owner','staff','client'])){
    ...
    public function asCompany()
    {
        ...
        $data=[
           ...
           'campaign'=>[
            ...
            'chats'=>[
                ...
                'sub_value'=>'',
                'sub_value_color'=>'text-success',
                'sub_title'=>"Conversaciones resueltas",
        ...
        //campaign
        $campaigns = Campaign::where('send_to', '>', 1)->where('is_simple', 0);// no toma en cuenta las de citas 
